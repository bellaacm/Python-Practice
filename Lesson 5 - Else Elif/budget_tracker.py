...
item = input("What item are you considering buying?")
...
print(f"This item takes up {percentage}% of your budget")
...
# Check if the percentage is less then 10 and say it's a small treat so enjoy
    ...
    print("This item is a small treat so enjoy")
# Check if it is less than 50 percent and if it is tell them it's a major spend and should sleep on it
elif percentage < 50:
    print("This item is a major spend and you should sleep on it")
...
# Otherwise, tell them it costs way too much and isn't worth it
    ...
    print("This item costs too much and isn't worth it")
